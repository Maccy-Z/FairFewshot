...
def get_results_by_dataset(test_data_names, models, num_rows=10, num_targets=5, ):
    """
...
def main(load_no, num_rows, fold_no, group_no):
...
if __name__ == "__main__":
    ...
    for g in [0, 2, 3, 4, 5]:
        print("----------------------------------------")
        print(f'Split number: {split}, group number{g}')
        col_accs = main(load_no=[-2], num_rows=10, fold_no=split, group_no=g)
